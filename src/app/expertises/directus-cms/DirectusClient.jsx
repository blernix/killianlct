...
import { ShieldCheck, Blocks, SlidersHorizontal, Database, Code, Users, Briefcase, Bot, CheckCircle, ShoppingCart, PenTool } from 'lucide-react';
      ...
      <main>
        ...
        <section className="w-full px-4 pt-32 pb-20 flex flex-col items-center justify-center text-center">
            <div className="relative w-full max-w-5xl">
                <p className="font-semibold text-gray-400">Back-office Sur-Mesure & Plateforme de Données</p>
                ...
                <p className="mt-6 text-lg max-w-3xl mx-auto text-gray-300">
                  Je ne vous livre pas une "boîte noire". Je construis votre site sur Directus, une plateforme de données open-source qui vous offre une interface d'administration 100% sur-mesure et vous garantit la pleine propriété de vos données, sans jamais être prisonnier d'une technologie.
                </p>
                <button 
                  onClick={openModal}
        ...
        <section className="py-16 sm:py-24 px-4 bg-white/5">
            <div className="mx-auto max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="relative aspect-square rounded-2xl overflow-hidden shadow-xl border border-white/10">
                    <Image 
                        src="/directuslogo.png" // URL factice
